...
- **Sort order** — Last added / First added
...
- **Related images** — horizontal scroll row of up to 8 keyword-matched images shown inside the lightbox and bottom sheet
- **Prompt overlay** — hovering a card (desktop) fades in the prompt as a gradient overlay over the image; tap to open for full details
...
- **Copy prompt** — one click from overlay, lightbox, or bottom sheet
